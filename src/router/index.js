...
var beihuanArr = [{
	...
	path: '/f_add_user', //新增用户
	name: 'f_add_user',
	component: resolve => require(['../views/firstGYS/f_add_user.vue'], resolve)
}, {
	path: '/f_edit_user', //编辑用户
	name: 'f_edit_user',
	component: resolve => require(['../views/firstGYS/f_edit_user.vue'], resolve)
}, {
	path: '/f_order', //采购订单列表
	name: 'f_order',
	component: resolve => require(['../views/firstGYS/f_order.vue'], resolve)
}, {
	path: '/f_order_xq', //采购订单详情
	name: 'f_order_xq',
	component: resolve => require(['../views/firstGYS/f_order_xq.vue'], resolve)
}, {
	path: '/f_zs', //采购商品追溯
	name: 'f_zs',
	component: resolve => require(['../views/firstGYS/f_zs.vue'], resolve)
}, {
	path: '/f_mine', //我的，个人中心
	name: 'f_mine',
	component: resolve => require(['../views/firstGYS/f_mine.vue'], resolve)
}, {
	path: '/f_information', //基础信息
	name: 'f_information',
	component: resolve => require(['../views/firstGYS/f_information.vue'], resolve)
}, {
	path: '/f_information_edit', //编辑基础信息
	name: 'f_information_edit',
	component: resolve => require(['../views/firstGYS/f_information_edit.vue'], resolve)
}, {
	path: '/f_addr', //地址信息
	name: 'f_addr',
	component: resolve => require(['../views/firstGYS/f_addr.vue'], resolve)
}, {
	path: '/f_store', //店铺信息
	name: 'f_store',
	component: resolve => require(['../views/firstGYS/f_store.vue'], resolve)
}, {
	path: '/f_ps_money', //配送信息
	name: 'f_ps_money',
	component: resolve => require(['../views/firstGYS/f_ps_money.vue'], resolve)
}, {
	path: '/f_down', //下载页面
	name: 'f_down',
	component: resolve => require(['../views/firstGYS/f_down.vue'], resolve)
}];
var elseArr = [{
	path: '/',
	name: CONFIG.urlName,
