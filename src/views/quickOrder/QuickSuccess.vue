		...
		<div id="OrderCheckoutSuccess">
			<div class="header gradient-y">
				<div class="flex flex-x-center flex-y-center">
					<img src="../../assets/imgs/listd_icon_succes.png" style="width: 0.42rem;height: 0.42rem;">
...
<script>
	...
	export default {
		...
		methods: {
			 ...
			 */
			toOrderDetails() {
				var o={name: 'QuickLookOrder'}
				if(this.$root.isFirstGYS){
						o={name: 'f_ddgl',}
					}
				this.$router.push(o)
			},
				...
				this.postRequest('product/sellerNewProductList', {
					...
					if(d.data && d.data.state == 0) {
						if(this.pageNum == 1) {
							...
							this.sellerNewProductList = [...this.sellerNewProductList, ...d.data.aaData];
						}
