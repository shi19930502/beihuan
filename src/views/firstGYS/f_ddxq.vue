<template>
	<yd-layout id='fDdxq'>
		...
		<div class="header" >
			<div class="header_left" @click='goFddgl'>销售订单</div>
			<div>销售订单详情</div>
			<div></div>
			<div class="ddzt">
		...
		<div class="content">
			...
			<div class="all_money">
				<a class="all_money_tel" :href="'tel:'+orderObj.buyerTel">联系客户</a>
...
<script>
	export default {
		...
		created() {
			this.$store.dispatch('changeNavBarTitle', '销售订单详情')
		},
		watch: {
